...
class TD3:
    def __init__(self,env,n_games: int = 300, training: bool = True,
                 ...
                 per_alpha: float = 0.6, per_beta: float = 0.4,mode:str = None
                 ):
    ...
    def save_models(self):
        torch.save(self.actor.state_dict(),self.directory + 'energy_actor.pth')
        torch.save(self.actor_target.state_dict(),self.directory+'energy_actor_target.pth')
        torch.save(self.critic_1.state_dict(),self.directory + 'energy_critic_1.pth')
        torch.save(self.critic_1_target.state_dict(),self.directory + 'energy_critic_1_target.pth')
        torch.save(self.critic_2.state_dict(),self.directory + 'energy_critic_2.pth')
        torch.save(self.critic_2_target.state_dict(),self.directory + 'energy_critic_2_target.pth')
        self.load = True
        print("==================================================")
    ...
    def load_models(self):
        self.actor.load_state_dict(torch.load(self.directory + 'energy_actor.pth'))
        self.actor_target.load_state_dict(torch.load(self.directory + 'energy_actor_target.pth'))
        self.critic_1.load_state_dict(torch.load(self.directory + 'energy_critic_1.pth'))
        self.critic_1_target.load_state_dict(torch.load(self.directory + 'energy_critic_1_target.pth'))
        self.critic_2.load_state_dict(torch.load(self.directory + 'energy_critic_2.pth'))
        self.critic_2_target.load_state_dict(torch.load(self.directory + 'energy_critic_2_target.pth'))
        print("==================================================")
